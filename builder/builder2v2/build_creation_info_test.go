...
func TestBuilder2_2CanBuildCreationInfoSection(t *testing.T) {
	...
	if ci.Creators[0].Creator != "github.com/codenotary/spdx-tools/builder" {
		t.Errorf("expected %s, got %s", "github.com/codenotary/spdx-tools/builder", ci.Creators[1].Creator)
	}
...
func TestBuilder2_2CanBuildCreationInfoSectionWithCreatorTool(t *testing.T) {
	...
	if ci.Creators[0].Creator != "github.com/codenotary/spdx-tools/builder" {
		t.Errorf("expected %s, got %s", "github.com/codenotary/spdx-tools/builder", ci.Creators[0])
	}
